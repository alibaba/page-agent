...
```html
<script
    src="https://cdn.jsdelivr.net/npm/page-agent@1.12.3/dist/iife/page-agent.demo.js"
    crossorigin="anonymous"
></script>

<!-- China CDN mirror if you can't access jsDelivr -->
<!-- https://registry.npmmirror.com/page-agent/1.12.3/files/dist/iife/page-agent.demo.js -->
```
