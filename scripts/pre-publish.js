...
// Internal @eb-agent/* workspace packages are bundled into dist by the lib
...
if (pkg.dependencies) {
	const internal = Object.keys(pkg.dependencies).filter((name) => name.startsWith('@eb-agent/'))
