...
import EBAgentCoreDocs from './advanced/eb-agent-core/page'
// Advanced
import EBAgentDocs from './advanced/eb-agent/page'
...
export default function DocsRouter() {
	return (
		<Switch>
			...
			{/* Advanced */}
			<Route path="/advanced/eb-agent">
				<DocsPage>
					<EBAgentDocs />
				</DocsPage>
			</Route>
			<Route path="/advanced/eb-agent-core">
				<DocsPage>
					<EBAgentCoreDocs />
				</DocsPage>
			</Route>
