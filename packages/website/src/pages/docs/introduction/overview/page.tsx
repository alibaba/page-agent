		...
		<article>
			<div className="mb-8">
				...
				<p className="text-xl text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">
					{isZh
						? 'eb-agent 是一个完全基于 Web 技术的 GUI Agent，简单几步，让你的网站拥有 AI 操作员。'
						: 'eb-agent is a purely web-based GUI Agent. Gives your website an AI operator in simple steps.'}
				</p>
				...
				<div className="flex flex-wrap gap-2 items-center">
					...
					<a
						href="https://www.npmjs.com/package/eb-agent"
						target="_blank"
						rel="noopener noreferrer"
					>
						<img src="https://img.shields.io/npm/dt/eb-agent.svg" alt="Downloads" />
					</a>
					<a
						href="https://bundlephobia.com/package/eb-agent"
						target="_blank"
						rel="noopener noreferrer"
					>
						<img src="https://img.shields.io/bundlephobia/minzip/eb-agent" alt="Bundle Size" />
					</a>
					<a
			...
			<section>
				<Heading id="what-is-eb-agent" className="text-2xl font-bold mb-4">
					{isZh ? '什么是 eb-agent？' : 'What is eb-agent?'}
				</Heading>

				<p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed ">
					{isZh
						? 'eb-agent 是一个页面内嵌式 GUI Agent。与传统的浏览器自动化工具不同，eb-agent 面向网站开发者，而非爬虫或Agent客户端开发者；将 Agent 集成到你的网站中，让用户可以通过自然语言与页面进行交互。'
						: 'eb-agent is an embedded GUI Agent. Unlike traditional browser automation tools, eb-agent is built for web developers and web applications first. Integrate it into your site to let users interact with pages through natural language.'}
				</p>
			</section>
